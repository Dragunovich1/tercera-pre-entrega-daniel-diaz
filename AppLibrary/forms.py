...
class ClienteFormulario(forms.Form):
    ...
    dni = forms.IntegerField(label="DNI (solo numeros)", widget=forms.TextInput(attrs={'class': 'alineacion-horizontal'}))
    
class EmpleadoFormulario(forms.Form):
    nombre = forms.CharField(max_length=50, label="Nombre", widget=forms.TextInput(attrs={'class': 'alineacion-horizontal'}))
    apellido = forms.CharField(max_length=50 , label="Apellido", widget=forms.TextInput(attrs={'class': 'alineacion-horizontal'}))
    dni = forms.IntegerField(label="DNI (solo numeros)", widget=forms.TextInput(attrs={'class': 'alineacion-horizontal'}))
    legajo = forms.IntegerField(label="Legajo (solo numeros)", widget=forms.TextInput(attrs={'class': 'alineacion-horizontal'})) 
    fecha_ingreso = forms.DateField(label="Fecha de Ingreso (DD/MM/AAAA)", widget=forms.TextInput(attrs={'class': 'alineacion-horizontal'}))
